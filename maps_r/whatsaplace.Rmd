...
knitr::include_graphics("figures/hb_convex.png")
```

Comparing with other figures, the convex hull of addresses does appear to capture the urban area of Herne Bay but also extends outwards beyyond it by a considerable extent into the parish of Herne and Broomfield.
...
knitr::include_graphics("figures/hb_and_others-convex.png")
```
...
knitr::include_graphics("figures/hb_bua.png")
```
...
knitr::include_graphics("figures/hb_and_whits_bua.png")
```
...
Despite these shortcomings, using BUA as a proxy for Coastal Town may be useful.
